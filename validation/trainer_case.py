...
'data.train_files':str(ROOT/'evidence/prompts.parquet'),'data.val_files':str(ROOT/'evidence/prompts.parquet'),'data.max_prompt_length':1024,'data.max_response_length':2048,'data.train_batch_size':2 if a.entry=='dapo' else 64,'data.shuffle':False,'data.dataloader_num_workers':0,
